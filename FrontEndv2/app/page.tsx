        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
            <div className="col-span-1 lg:col-span-5">
              <h1 className="text-5xl md:text-7xl font-bold uppercase tracking-tighter mb-2">Alexis Hernandez</h1>
              <p className="text-base text-muted-foreground uppercase tracking-wider">
                IT Professional / Microsoft 365 & Azure
              </p>
            </div>
            <div className="col-span-1 lg:col-span-2 flex justify-start lg:justify-center items-center">
              <LightsToggle />
            </div>
            <div className="col-span-1 lg:col-span-5 flex justify-start lg:justify-end items-center">
              <SignalDetector />
            </div>
          </div>
          <div className="mt-6">
            <a href="https://www.alexbuilds.cc/" className="hardware-button inline-flex items-center border-0 gap-2 px-24 py-0 my-0 mx-6">
              <span>←</span>
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <path d="M12 6c-3.309 0-6 2.691-6 6s2.691 6 6 6 6-2.691 6-6-2.691-6-6-6zm0 10c-2.206 0-4-1.794-4-4s1.794-4 4-4 4 1.794 4 4z" />
                </svg>
              </a>
            </div>
