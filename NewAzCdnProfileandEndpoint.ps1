[CmdletBinding()]
param (
    [Parameter(Mandatory, HelpMessage='Your CDN Profile Name.')]
    [string]
    $CdnProfileName,

    [Parameter(Mandatory, HelpMessage='Your CDN Endpoint Name.')]
    [string]
    $CdnEndpointName,
...
az cdn endpoint create --resource-group $ResourceGroup --profile-name $CdnProfileName --name $CdnEndpointName --origin $StaticWebsiteUrl --origin-host-header $StaticWebsiteUrl --location $Region --no-http true 